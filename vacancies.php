...
<?php include('includes/header.php'); ?>
    ...
    <div id="page-content">
        <div class="main-image vacancies">
            <img src="images/photos/vacancies_headpic.png">
        </div>
        <div class="main-content">
            <h1 class="white">Vacancies</h1>
        </div>
    </div>
    <div class="silver-bar">Vacancies</div>
    ...
    <div class="section-2" id="section-2">
     ...
     <div class="section-3" id="section-3">
        <ul class="benefits-nav">
            <li class=" item-1"><a href="#">Take me to<br><span class="line2text">Search Jobs</span></a></li>
        </ul>
